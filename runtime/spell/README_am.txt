See original package:  http://ftp.gnu.org/gnu/aspell/dict/am/aspell6-am-0.03-1.tar.bz2 
Conversion made by Laszlo Nemeth, for demonstration of Hunspell Unicode support
(see http://hunspell.sourceforge.net)
ORIGINAL README:
-----------------------------

GNU Aspell 0.60 Amharic (አማርኛ) Dictionary Package
Version 0.03-1
2004-12-28
Original Word List By:
  Daniel Yacob
Copyright Terms: Public Domain (see the file Copyright for the exact terms)
This word list is considered accurate but incomplete.

This is the Amharic dictionary for Aspell.  It requires Aspell 
...
After the dictionaries are installed you can use the main one (am) by
setting the LANG environmental variable to am or running Aspell
with "--lang=am".  You may also chose the dictionary directly
