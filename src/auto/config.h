...
/* Define if you want to include the SpiderMonkey interpreter. */
/* #undef FEAT_SPIDERMONKEY */
...
/* Define if you want to include japanese encoding autodetection. */
/* #undef FEAT_GUESS_ENCODE_JP */

/* Define if you want to include japanese encoding autodetection. */
/* #undef FEAT_CODECHECK */
