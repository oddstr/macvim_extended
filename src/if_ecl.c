...
"  (defclass msg-stream (gray::fundamental-character-output-stream)         \n"
"    ((buffer :initform \"\")))                                             \n"
"                                                                           \n"
"  (defmethod gray:stream-write-char ((strm msg-stream) char)                 \n"
...
"                       :buffer buffer))))                                  \n"
"                                                                           \n"
"  (defclass vim-buf-stream (gray::fundamental-character-output-stream)       \n"
"    ((buffer :accessor buffer :initform nil)))                             \n"
"                                                                           \n"
"  (defmethod gray:stream-line-column ((strm msg-stream))                     \n"
"    (with-slots (buffer) strm                                              \n"
"      (length buffer)))                                                    \n"
"                                                                           \n"
"  (defmethod gray:stream-write-char ((strm vim-buf-stream) char)             \n"
