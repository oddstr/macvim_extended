...
EX(CMD_sprevious,	"sprevious",	ex_previous,
			EXTRA|RANGE|NOTADR|COUNT|BANG|EDITCMD|ARGOPT|TRLBAR),
/* To make ":split" precedence, this is placed not sorted position. */
EX(CMD_spidermonkey,	"spidermonkey",	ex_spidermonkey,
			RANGE|EXTRA|NEEDARG|CMDWIN),
EX(CMD_spidermonkeyfile,"spidermonkeyfile",	ex_spidermonkeyfile,
			RANGE|FILE1|NEEDARG|CMDWIN),
